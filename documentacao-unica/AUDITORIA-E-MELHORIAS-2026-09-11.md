...
| 2026-09-14 | ARQ-01 | A criação de snapshots completos de NPCs foi movida ao módulo puro de sessão, preservando os dados necessários à reversão. | Em validação local: 5 cenários unitários, lint, build e `git diff --check`. | Publicar, acompanhar o gate e extrair a leitura/reconstrução do snapshot. |
