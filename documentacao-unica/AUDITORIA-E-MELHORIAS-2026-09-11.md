...
| 2026-09-13 | UX-03 | Concessões de ficha de campanha passaram a ter seções legíveis, descrição narrativa multilinha e controles guiados para escolhas obrigatórias. | `eb7217f`; frontend: 379 testes, build e `git diff --check` aprovados localmente. | Aguardar Quality Gate, publicação e executar os novos casos manuais acumulados. |
