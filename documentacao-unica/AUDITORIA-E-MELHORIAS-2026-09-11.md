...
| 2026-09-13 | UX-03 | Tags de homebrew passaram de lista separada por vírgulas a chips editáveis; filtro técnico por código saiu do painel de técnicas. | `8504b4c`; frontend: 379 testes e build; Quality Gate remoto pendente. | Publicar, acompanhar o Quality Gate e executar os casos manuais acumulados. |
