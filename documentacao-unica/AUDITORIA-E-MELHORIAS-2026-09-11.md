...
| 2026-09-14 | ARQ-01 | A montagem do payload de restauração de NPCs passou a reutilizar o módulo puro de snapshots. | Em validação local: 5 cenários unitários, lint, build e `git diff --check`. | Publicar e acompanhar o gate; manter a validação de eventos legados no serviço. |
