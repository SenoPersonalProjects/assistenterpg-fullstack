...
| 2026-09-12 | UX-03 | Cadastro de clãs migrou técnicas hereditárias de IDs CSV para seleção guiada. | `cccee52`; validações locais do frontend registradas em UX-03. | Publicar e validar o gate remoto; seguir com requisitos estruturados e outros catálogos. |
