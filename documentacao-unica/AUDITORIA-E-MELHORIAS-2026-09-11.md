...
| 2026-09-13 | UX-03 | Configurações de poderes genéricos passaram a ter resumo textual reutilizável na ficha-base e nas concessões de campanha, sem JSON técnico. | `f5bc87b`; frontend: 379 testes e build; Quality Gate remoto pendente. | Publicar, acompanhar o Quality Gate e executar os casos manuais acumulados. |
