...
- backend contrato de DTO do inventario:
  ...
  - [`assistenterpg-back/src/common/filters/error-contract.integration.spec.ts`](../assistenterpg-back/src/common/filters/error-contract.integration.spec.ts) valida o contrato de erro para `GET /inventario/personagem/:personagemBaseId`, `PATCH /inventario/item/:itemId`, `POST /inventario/adicionar`, `POST /inventario/aplicar-modificacao` e `POST /inventario/remover-modificacao` com payload/param invalido
