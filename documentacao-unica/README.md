...
- backend contrato de DTO do inventario:
  ...
  - [`assistenterpg-back/src/common/filters/error-contract.integration.spec.ts`](../assistenterpg-back/src/common/filters/error-contract.integration.spec.ts) valida o contrato de erro para `PATCH /inventario/item/:itemId` e `POST /inventario/adicionar` com payload invalido
