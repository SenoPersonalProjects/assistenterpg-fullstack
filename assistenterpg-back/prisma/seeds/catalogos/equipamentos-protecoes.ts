...
export const equipamentosProtecoesSeed: EquipamentoProtecaoSeed[] = [
  ...
  },
  {
    ...
    descricao: 'Equipamento usado por forças especiais da polícia e pelo exército. Consiste de capacete, ombreiras, joelheiras e caneleiras, além de um colete com várias camadas de kevlar. Fornece resistência a dano físico 2, além de +5 na defesa. Impõe –5 em testes de perícias que sofrem penalidade de carga.',
    tipo: TipoEquipamento.PROTECAO,
