// src/tecnicas-amaldicoadas/engine/tecnicas-amaldicoadas.engine.types.ts
...
export type VariacaoImportNormalizada = Omit<
...
export type HabilidadeImportNormalizada = Omit<
...
export const TECNICAS_JSON_SCHEMA = 'tecnicas-amaldicoadas.import-export';
export const TECNICAS_JSON_SCHEMA_VERSION = 1;
