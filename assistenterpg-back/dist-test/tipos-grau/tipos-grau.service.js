...
exports.TiposGrauService = void 0;
const common_1 = require("@nestjs/common");
const client_1 = require("@prisma/client");
const prisma_service_1 = require("../prisma/prisma.service");
const tipo_grau_exception_1 = require("src/common/exceptions/tipo-grau.exception");
const database_exception_1 = require("src/common/exceptions/database.exception");
let TiposGrauService = class TiposGrauService {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async findOne(id) {
        try {
            ...
            if (!tipo) {
                throw new tipo_grau_exception_1.TipoGrauNaoEncontradoException(id);
            }
            return tipo;
        }
        catch (error) {
...
exports.TiposGrauService = TiposGrauService;
exports.TiposGrauService = TiposGrauService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], TiposGrauService);
//# sourceMappingURL=tipos-grau.service.js.map