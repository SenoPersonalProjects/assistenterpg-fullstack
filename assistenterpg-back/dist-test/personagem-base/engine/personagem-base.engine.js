...
const inventario_capacidade_1 = require("src/inventario/utils/inventario-capacidade");
...
async function calcularEstadoFinalPersonagemBase(params) {
    ...
    const espacosInventarioBase = (0, inventario_capacidade_1.calcularEspacosInventarioBase)(atributoInventarioBase);
