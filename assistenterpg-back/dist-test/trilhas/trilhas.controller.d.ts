...
export declare class TrilhasController {
    private readonly trilhasService;
    constructor(trilhasService: TrilhasService);
    ...
    findCaminhos(id: number): Promise<{
        id: number;
        nome: string;
        descricao: string | null;
        trilhaId: number;
    }[]>;
    findHabilidades(id: number): Promise<{
        id: number;
        nivelConcedido: number;
        habilidadeId: number;
