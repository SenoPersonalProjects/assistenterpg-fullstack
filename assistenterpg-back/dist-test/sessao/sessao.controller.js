...
const atualizar_valor_iniciativa_sessao_dto_1 = require("./dto/atualizar-valor-iniciativa-sessao.dto");
...
const adicionar_personagem_sessao_dto_1 = require("./dto/adicionar-personagem-sessao.dto");
let SessaoController = class SessaoController {
    ...
    async atualizarValorIniciativaSessao(campanhaId, sessaoId, req, dto) {
        const resultado = await this.sessaoService.atualizarValorIniciativaSessao(campanhaId, sessaoId, req.user.id, dto);
        this.sessaoGateway.emitirSessaoAtualizada(campanhaId, sessaoId, 'INICIATIVA_VALOR_ATUALIZADO');
        return resultado;
    }
    ...
    async adicionarPersonagemSessao(campanhaId, sessaoId, req, dto) {
        const resultado = await this.sessaoService.adicionarPersonagemSessao(campanhaId, sessaoId, req.user.id, dto);
        this.sessaoGateway.emitirSessaoAtualizada(campanhaId, sessaoId, 'PERSONAGEM_ATUALIZADO');
        return resultado;
    }
    async removerPersonagemSessao(campanhaId, sessaoId, personagemSessaoId, req) {
        const resultado = await this.sessaoService.removerPersonagemSessao(campanhaId, sessaoId, personagemSessaoId, req.user.id);
        this.sessaoGateway.emitirSessaoAtualizada(campanhaId, sessaoId, 'PERSONAGEM_ATUALIZADO');
        return resultado;
    }
...
__decorate([
    (0, common_1.Patch)(':sessaoId/iniciativa/valor'),
    __param(0, (0, common_1.Param)('campanhaId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('sessaoId', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Request)()),
    __param(3, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, Object, atualizar_valor_iniciativa_sessao_dto_1.AtualizarValorIniciativaSessaoDto]),
    __metadata("design:returntype", Promise)
], SessaoController.prototype, "atualizarValorIniciativaSessao", null);
__decorate([
...
__decorate([
    (0, common_1.Post)(':sessaoId/personagens'),
    __param(0, (0, common_1.Param)('campanhaId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('sessaoId', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Request)()),
    __param(3, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, Object, adicionar_personagem_sessao_dto_1.AdicionarPersonagemSessaoDto]),
    __metadata("design:returntype", Promise)
], SessaoController.prototype, "adicionarPersonagemSessao", null);
__decorate([
    (0, common_1.Delete)(':sessaoId/personagens/:personagemSessaoId'),
    __param(0, (0, common_1.Param)('campanhaId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('sessaoId', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Param)('personagemSessaoId', common_1.ParseIntPipe)),
    __param(3, (0, common_1.Request)()),
    ...
    __metadata("design:returntype", Promise)
], SessaoController.prototype, "removerPersonagemSessao", null);
__decorate([
