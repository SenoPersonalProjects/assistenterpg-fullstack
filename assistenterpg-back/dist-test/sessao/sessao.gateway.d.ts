...
type EventoSessaoAtualizada = {
    campanhaId: number;
    sessaoId: number;
    tipo: 'CHAT_NOVA' | 'CENA_ATUALIZADA' | 'TURNO_AVANCADO' | 'TURNO_RECUADO' | 'TURNO_PULADO' | 'ORDEM_INICIATIVA_ATUALIZADA' | 'INICIATIVA_VALOR_ATUALIZADO' | 'NPC_ATUALIZADO' | 'PERSONAGEM_ATUALIZADO' | 'SESSAO_ENCERRADA' | 'SESSAO_EVENTO_DESFEITO' | 'HABILIDADE_USADA' | 'HABILIDADE_SUSTENTADA_ENCERRADA' | 'CONDICAO_APLICADA' | 'CONDICAO_REMOVIDA';
    em: string;
};
