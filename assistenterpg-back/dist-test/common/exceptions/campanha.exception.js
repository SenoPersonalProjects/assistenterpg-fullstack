...
class SessaoOrdemIniciativaInvalidaException extends business_exception_1.BusinessException {
    constructor(sessaoId, campanhaId) {
        super('Ordem de iniciativa invalida para os participantes atuais da sessao', 'SESSAO_ORDEM_INICIATIVA_INVALIDA', {
            sessaoId,
            campanhaId,
        });
    }
}
exports.SessaoOrdemIniciativaInvalidaException = SessaoOrdemIniciativaInvalidaException;
...
class PersonagemSessaoNaoEncontradoException extends base_exception_1.BaseException {
    constructor(personagemSessaoId, sessaoId, campanhaId) {
        super('Personagem da sessao nao encontrado', common_1.HttpStatus.NOT_FOUND, 'PERSONAGEM_SESSAO_NOT_FOUND', {
            personagemSessaoId,
            sessaoId,
            campanhaId,
        });
...
exports.PersonagemSessaoNaoEncontradoException = PersonagemSessaoNaoEncontradoException;
