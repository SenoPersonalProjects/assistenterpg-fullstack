...
exports.HabilidadeEmUsoException = exports.TipoGrauNaoEncontradoException = exports.HabilidadeCodigoDuplicadoException = exports.HabilidadeNomeDuplicadoException = exports.HabilidadeNaoEncontradaException = void 0;
...
class HabilidadeNaoEncontradaException extends base_exception_1.BaseException {
    constructor(identificador) {
        super('Habilidade nao encontrada', common_1.HttpStatus.NOT_FOUND, 'HABILIDADE_NOT_FOUND', { identificador });
    }
}
...
class HabilidadeNomeDuplicadoException extends business_exception_1.BusinessException {
    constructor(nome) {
        super(`Habilidade com nome "${nome}" ja existe`, 'HABILIDADE_NOME_DUPLICADO', { nome });
    }
}
...
class HabilidadeCodigoDuplicadoException extends business_exception_1.BusinessException {
    constructor(codigo) {
        super(`Habilidade com codigo "${codigo}" ja existe`, 'HABILIDADE_CODIGO_DUPLICADO', { codigo });
    }
}
...
class TipoGrauNaoEncontradoException extends base_exception_1.BaseException {
    constructor(codigosInvalidos) {
        super(`Tipos de grau nao encontrados: ${codigosInvalidos.join(', ')}`, common_1.HttpStatus.NOT_FOUND, 'TIPO_GRAU_NOT_FOUND', { codigosInvalidos });
    }
}
...
class HabilidadeEmUsoException extends business_exception_1.BusinessException {
    constructor(habilidadeId, totalUsos, detalhesUso) {
        super(`Habilidade esta sendo usada por ${totalUsos} entidade(s). Remova as referencias primeiro.`, 'HABILIDADE_EM_USO', { habilidadeId, totalUsos, detalhesUso });
    }
}
