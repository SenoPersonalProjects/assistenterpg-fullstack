...
export declare class SessaoOrdemIniciativaInvalidaException extends BusinessException {
    constructor(sessaoId?: number, campanhaId?: number);
}
export declare class CenaSessaoNaoEncontradaException extends BaseException {
...
export declare class PersonagemSessaoNaoEncontradoException extends BaseException {
    constructor(personagemSessaoId?: number, sessaoId?: number, campanhaId?: number);
}
export declare class SessaoEventoNaoEncontradoException extends BaseException {
    constructor(eventoId?: number, sessaoId?: number, campanhaId?: number);
}
export declare class SessaoEventoDesfazerNaoPermitidoException extends BusinessException {
