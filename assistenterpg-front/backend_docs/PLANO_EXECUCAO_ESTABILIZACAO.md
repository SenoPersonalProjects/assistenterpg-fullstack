...
- Etapa inicial aplicada em `backend_docs/PR1_BUILD_HEALTH_STATUS.md`.
...
- Publicar artefato versionado (`v1.json`, `v1.1.json`, etc.) sob `backend_docs/openapi/`.
- Registrar breaking changes em `backend_docs/CONTRATO_API_CHANGELOG.md`.

### Critérios de aceite

- Arquivo OpenAPI versionado disponível no repositório.
- `backend_docs/BACKEND_CONTRACT_VERSION.md` atualizado com commit/tag correto.
