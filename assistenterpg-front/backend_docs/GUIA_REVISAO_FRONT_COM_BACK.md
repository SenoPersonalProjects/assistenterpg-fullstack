...
- `backend_docs/API_CONTRACT_SNAPSHOT.md` (mapa rápido de endpoints/contratos para implementação de telas)
- `backend_docs/FRONT_NEXT_INTEGRATION_PLAYBOOK.md` (boas práticas para Next componentizado + reuso)
- `backend_docs/CONTRATO_API_CHANGELOG.md` (fonte de mudanças que impactam o front)
- `backend_docs/FRONT_REQUEST_RESPONSE_EXAMPLES.md` (payloads e respostas de referência)
- `backend_docs/FRONT_ERROR_HANDLING_GUIDE.md` (tratativa de erros para UX consistente)
...
- Definir uma convenção simples no back, por exemplo:
  - `backend_docs/CONTRATO_API_CHANGELOG.md`;
...
1. No **back**:
   - manter `backend_docs/GUIA_REVISAO_FRONT_COM_BACK.md` (este arquivo) e atualizar a cada mudança de contrato;
