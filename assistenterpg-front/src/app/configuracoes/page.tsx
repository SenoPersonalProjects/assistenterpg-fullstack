                    ...
                    >
                      <div className="grid gap-6 md:grid-cols-3">
                        ...
                        <Card variant="flat" className="bg-app-surface/30 p-4 border border-app-border/50">
                          ...
                          <p className="text-lg font-black text-app-fg">Maledicência RPG</p>
                        </Card>
                        <Card variant="flat" className="bg-app-surface/30 p-4 border border-app-border/50">
                      ...
                      <div className="flex flex-col gap-3 pt-4">
                        ...
                        <p className="max-w-xl text-xs leading-relaxed text-app-muted">
                          Este assistente ajuda mestres e jogadores a organizar campanhas, personagens, regras e sessões no Maledicência RPG.
                        </p>
                      </div>
                    </ConfigSection>
                  )}
