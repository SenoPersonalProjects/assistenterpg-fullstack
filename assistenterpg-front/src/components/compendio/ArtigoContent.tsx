  ...
  return (
    <div className="prose prose-invert max-w-none">
      <ReactMarkdown
        ...
        components={{
          h1: ({ ...props }) => <h1 className="text-3xl font-bold text-app-fg mb-4" {...props} />,
          h2: ({ ...props }) => <h2 className="text-2xl font-semibold text-app-fg mt-6 mb-3" {...props} />,
          h3: ({ ...props }) => <h3 className="text-xl font-semibold text-app-fg mt-4 mb-2" {...props} />,
          p: ({ ...props }) => <p className="text-app-fg mb-4 leading-relaxed" {...props} />,
          ...
          thead: ({ ...props }) => <thead className="bg-app-surface" {...props} />,
          th: ({ ...props }) => (
